...
namespace ShellSort_Estudiantes
{
    public partial class Form1 : Form
    {
        ...
        public void RefrescarDGV() 
        {
            ...
            foreach (Estudiante unEstudiante in arregloEstudiante)
            {
                dgEstudiantes.Rows.Add(unEstudiante.Matricula, unEstudiante.Nombre,
               unEstudiante.Grado.ToString(), unEstudiante.Grupo.ToString(),
               unEstudiante.Promedio.ToString("N2"));
            }
        ...
        {
            arregloEstudiante = new Estudiante[aleatorio.Next(100, 500)];
